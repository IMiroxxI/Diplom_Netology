terraform {
  required_providers {
    yandex = {
      ...
      version = ">= 0.89.0"  # опционально, но рекомендуется
    }
  }
  required_version = ">= 1.0"  # опционально
}

provider "yandex" {
  token     = "y0__xCUgYz4ARjB3RMgg86k7RWshDuyg1T8zuK29tc5T0SUZhVmDQ"
  cloud_id  = "b1g1588e64mablafhoda"
  folder_id = "b1gciq75pffngdc2ebs6"
  zone      = "ru-central1-a"
}
