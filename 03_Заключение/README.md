...
Ключевая задача была разработать отказоустойчивую инфраструктуру для сайта, включающую мониторинг, сбор логов и резервное копирование основных данных. 
Инфраструктура размещена в Yandex Cloud и отвечает минимальным стандартам безопасности.

### Инфраструктура
Развертывание инфраструктуры производилось с использованием Terraform и Ansible.
...
В большенстве использовались минимальные конфигурации ВМ: 2 ядра 20% Intel ice lake, 2-4Гб памяти, 10hdd. 
